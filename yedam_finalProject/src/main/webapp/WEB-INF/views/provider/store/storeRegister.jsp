				...
				<div id = "st_Table">
					...
					<table  class="form-control" >
						...
						<tr>
							...
							<tr>
							<th>사업자 이름  </th>
							<td id = "member_name"><input type="text"class="form-control mb-3 mt-3" style="width:200px" placeholder="${user.name }" disabled >
							</td>
						</tr>
						<tr>
							<th>매장 이미지 </th>
						...
						<tr>
							<th>매장 전화번호  </th>
							<td id = "store_tel"><input type="text" id="st_tel" class="form-control mb-3 mt-3" name="tel" style="width:200px" placeholder= "${user.tel }">
							</td>
						</tr>
						<tr>
							<th>주소</th>
							<td>
								...
								<button type="button" class="col-4 btn btn-outline-gray-700" id="postCodeBtn" onclick="locationSearch()">주소 검색</button>

...
<!-- 	<h3>검색</h3> -->
<div style="background-image: url(${pageContext.request.contextPath}/resources/img/home_bg.png); min-height: 75vh">
				...
				<div class="card-body justify-content-center">
					...
					<div class="nav-wrapper position-relative mb-2 justify-content-between">
					    <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-text" role="tablist">
					        ...
					        <li class="nav-item" style="font-family: 'Jeju Gothic', sans-serif;">
					            <a class="nav-link mb-sm-3 mb-md-0" id="tabs-text-2-tab" data-bs-toggle="tab" href="#tabs-text-2" role="tab" aria-controls="tabs-text-2" aria-selected="false">사업자회원</a>
					        </li>
					    </ul>
					</div>
					<!-- End of Tab Nav -->

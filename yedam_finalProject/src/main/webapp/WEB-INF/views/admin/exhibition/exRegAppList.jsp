...
<div align="center">
	<div class="input-group" style="width:500px;">
		...
		<input type="text"  class="form-control mb-3" id="input" onkeypress="f_enterLogin()">
		<button href="javascript:f_loginCheck();" type="button" id="searchBtn" class="input-group-text mb-3" >
